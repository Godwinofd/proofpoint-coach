                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    {SCENARIOS.map((scenario) => (
                        <button
                            ...
                            className={`text-left p-4 rounded-xl border transition ${selectedScenario === scenario.id
                                ? 'bg-green-950/30 border-green-500 ring-1 ring-green-500/50'
                                : 'bg-gray-950 border-gray-800 hover:border-gray-700'
                                }`}
                        >
                            <div className={`w-10 h-10 rounded-lg flex items-center justify-center mb-3 ${selectedScenario === scenario.id ? 'bg-green-900/50 text-green-400' : 'bg-gray-900 text-gray-400'
                                }`}>
                                {scenario.icon}
                            </div>
                            ...
                            >
                                <div>
                                    <div className="flex items-center gap-3 mb-1">
                                        ...
                                        <span className={`text-xs px-2 py-0.5 rounded-full ${session.status === 'completed' ? 'bg-emerald-950/50 text-emerald-400 border border-emerald-900' :
